...
save(spec_5_1_panel, file = "data/spec_5_1_panel_maj.RData")
...
spec_5_2_panel_maj$q_1 <- ifelse(spec_5_2_panel_maj$total_assistance < spec_5_2_panel_maj$p_1, 1, 0)
...
spec_5_2_panel_maj$q_4 <- ifelse(spec_5_2_panel_maj$total_assistance >= spec_5_2_panel_maj$p_3, 1, 0)
...
spec_5_2_panel_maj <- merge(aggregate(cbind(nr_dis_lag_0.25, nr_dis_lag_0.5, nr_dis_lag_0.5_e, nr_dis_lag_1_e) ~ fips_code + date + data_series + incident_category_man, spec_5_2_panel_maj, sum, na.rm = TRUE),
                            select(spec_5_2_panel_maj, -starts_with("nr_dis_lag"), -incident_type)[!(duplicated(spec_5_2_panel_maj[,c("fips_code", "date", "data_series", "incident_category_man")])),],
...
spec_5_3_panel_maj$q_1 <- ifelse(spec_5_3_panel_maj$total_assistance < spec_5_3_panel_maj$p_1, 1, 0)
...
spec_5_3_panel_maj$q_4 <- ifelse(spec_5_3_panel_maj$total_assistance >= spec_5_3_panel_maj$p_3, 1, 0)
